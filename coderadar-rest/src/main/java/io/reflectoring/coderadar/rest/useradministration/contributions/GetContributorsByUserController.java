...
public class GetContributorsByUserController {
    ...
    public ResponseEntity<List<GetContributorResponse>> getContributorsByUser(@PathVariable long userId) {
        return ResponseEntity.ok(mapContributors(getContributorsByUserUseCase.getContributorsByUser(userId)));
    }
}
